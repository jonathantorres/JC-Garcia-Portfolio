<?php
    ...
    /*
    Plugin Name: Tweets As Posts
    Plugin URI: http://www.chandeshparekh.com/plugins/
    Description: Import Twitter updates and display as WordPress Posts
    Version: 1.1
    Author: Chandesh Parekh
    Author URI: http://www.chandeshparekh.com
    */
    ...
    function tap_admin_actions() {
	    add_options_page("Tweets As Posts", "Tweets As Posts", 1, "tweets-as-posts-admin", "tap_admin");
	};
