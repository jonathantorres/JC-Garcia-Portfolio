...
<form name="tap_options_form" method="post" action="<?php echo str_replace( "%7E", "~", $_SERVER["REQUEST_URI"]); ?>">
	...
	<table class="form-table">
	    ...
	    <tr>
	        ...
	        <td><input type="text" name="tap_usernames" id="tap_usernames" value="<?php echo $usernames; ?>" size="40">&nbsp;<em>eg: chandeshparekh, happyupbringing (don't include the @)</em></td>
	    </tr>
	    <tr>
	        <th><label for="name="tap_add_news_as_post">Add Tweets as Posts:</label></th>
