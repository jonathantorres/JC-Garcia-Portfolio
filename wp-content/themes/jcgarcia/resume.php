			...
			<div class="resume">
				<div class="profile">
					...
					<div class="profile_content">
						...
						<a href="#" class="dark_button linkedin">Linkedin</a>
						<a href="#" class="dark_button contacto">Contacto</a>
					</div>
				</div><!-- .profile -->
				
				<div class="renglon experience">
					<div class="heading">
				...
				</div><!-- .renglon .experience -->
				
				<div class="renglon projects">
					<div class="heading">
						<h1>Proyectos</h1>
						<div class="nav">
							<span class="arrow left"></span>
				...
				</div><!-- .renglon .projects -->
				
				<div class="renglon education">
					<div class="heading">
						<h1>Educacion</h1>
						<div class="nav">
							<span class="arrow left"></span>
				...
				</div><!-- .renglon .education -->
				
				<div class="renglon recomendation">
					<div class="heading">
